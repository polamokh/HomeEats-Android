...
public class CartOrderItem extends OrderItem {
    ...
    public CartOrderItem(String id, String foodBuyerId, String mealItemId, Integer quantity, String notes, Integer rating) {
        super(mealItemId, quantity, notes, rating);
        this.id = id;
