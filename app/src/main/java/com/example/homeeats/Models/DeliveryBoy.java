...
public class DeliveryBoy extends Client {
    ...
    public DeliveryBoy(String id, String name, String gender, String emailAddress, String phone, String photo, boolean availability, LatLng location, long lastSeen) {
