   ...
   edit.setOnClickListener(new View.OnClickListener() {
       ...
       public void onClick(View v)
       {
           ...
           final MealItem MI = new MealItem(Meal_ID, edited_name.getText().toString(),
                   ...
                   Double.parseDouble(edited_price.getText().toString()),Edited_Category.getText().toString(), 4.5);
           MealItemDao.GetInstance().save(MI, Meal_ID, new TaskListener() {
               @Override
               public void OnSuccess() {
                   MealItemDao.GetInstance().setMealImage(Meal_ID, Foodmaker_ID, selectedImage, new RetrievalEventListener<String>() {
                       @Override
